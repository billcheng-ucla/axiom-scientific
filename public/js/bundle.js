...
exports.default = _alt2.default.createActions(CartActions);
...
var HomeActions = function () {
	function HomeActions() {
		...
		this.generateActions('getProductsSuccess', 'getHomeFail');
	}
	...
	_createClass(HomeActions, [{
		...
		value: function getProducts() {
			...
			$.ajax({ url: '/api/products/' }).done(function (data) {
...
},{"../alt":7,"./CartActions":1,"react":"react"}],4:[function(require,module,exports){
'use strict';
...
var NavbarActions = function NavbarActions() {
	...
	this.generateActions('updateSeachQuery');
};

exports.default = _alt2.default.createActions(NavbarActions);

},{"../alt":7,"lodash":45}],5:[function(require,module,exports){
'use strict';
...
var ProductActions = function () {
	function ProductActions() {
		...
		this.generateActions('getProductSuccess', 'getProductFail', 'updateItemsWanted');
	}

	_createClass(ProductActions, [{
		key: 'getProduct',
		value: function getProduct(sku) {
			var _this = this;

			$.ajax({ url: '/api/products/' + sku }).done(function (data) {
...
exports.default = _alt2.default.createActions(ProductActions);
...
},{"../alt":7,"react":"react"}],7:[function(require,module,exports){
'use strict';
...
var AxiomSci = function (_React$Component) {
	_inherits(AxiomSci, _React$Component);

	function AxiomSci() {
		_classCallCheck(this, AxiomSci);

		return _possibleConstructorReturn(this, (AxiomSci.__proto__ || Object.getPrototypeOf(AxiomSci)).apply(this, arguments));
	}

	_createClass(AxiomSci, [{
		key: 'render',
...
exports.default = AxiomSci;

},{"./Footer":10,"./Navbar":13,"react":"react"}],9:[function(require,module,exports){
'use strict';
...
var Cart = function (_React$Component) {
	...
	_createClass(Cart, [{
		...
		value: function componentDidMount() {
			_CartStore2.default.listen(this.onChange);
			if (localStorage.user) {
		...
		value: function componentWillUnmount() {
			_CartStore2.default.unlisten(this.onChange);
		}
	}, {
		key: 'onChange',
...
},{"../actions/CartActions":1,"../stores/CartStore":20,"react":"react"}],10:[function(require,module,exports){
'use strict';
...
var Footer = function (_React$Component) {
  ...
  _createClass(Footer, [{
    ...
    key: 'render',
    value: function render() {
      var links = ["About Us", "Privacy Policy", "Terms of Use", "Careers", "Contact", "Help"].map(function (link) {
        return _react2.default.createElement(
          'div',
          { className: 'col-lg-2', key: link },
          _react2.default.createElement(
            _reactRouter.Link,
            { to: '#' },
            link
...
},{"../actions/NavbarActions":4,"../stores/NavbarStore":23,"react":"react","react-router":"react-router"}],11:[function(require,module,exports){
'use strict';
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      _HomeActions2.default.getProducts();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            ' Placeholder Zerg Product Description '
          ),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            ' Placeholder Protoss Product Description '
          ),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            ' Placeholder Materials Product Description '
          ),
...
},{"../actions/HomeActions":2,"../stores/HomeStore":21,"./Tab":16,"./Tabs":17,"react":"react"}],12:[function(require,module,exports){
'use strict';
...
var Login = function (_React$Component) {
	...
	_createClass(Login, [{
		...
		value: function handleSubmit(e) {
			...
			_LoginActions2.default.loginUser(user);
		}
	}, {
		key: 'render',
		value: function render() {
...
},{"../actions/LoginActions":3,"../stores/LoginStore":22,"react":"react","react-router":"react-router"}],13:[function(require,module,exports){
'use strict';
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: "Type Item # or keyword", value: this.state.searchQuery, onChange: _NavbarActions2.default.updateSearchQuery }),
								_react2.default.createElement(
									'span',
									{ className: 'input-group-btn' },
									_react2.default.createElement(
										'button',
										{ className: 'btn btn-default', onClick: this.handleSearch.bind(this) },
...
},{"../actions/CartActions":1,"../actions/NavbarActions":4,"../stores/NavbarStore":23,"./Cart":9,"react":"react","react-router":"react-router"}],14:[function(require,module,exports){
'use strict';
...
var Product = function (_React$Component) {
	...
	function Product(props) {
		...
		_this.state = _ProductStore2.default.getState();
		_this.onChange = _this.onChange.bind(_this);
		return _this;
	}
	...
	_createClass(Product, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
			_ProductStore2.default.listen(this.onChange);
			_ProductActions2.default.getProduct(this.props.params.sku);
		}
	}, {
		key: 'componentWillUnmount',
		value: function componentWillUnmount() {
			_ProductStore2.default.unlisten(this.onChange);
		}
	}, {
		...
		value: function updateCart() {
			if (this.state.itemsWanted <= this.state.quantity) {
				...
				_CartActions2.default.updateShoppingCart(myItem);
			}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('input', { type: 'number', value: this.state.itemsWanted, onChange: _ProductActions2.default.updateItemsWanted }),
					' (max: ',
					this.state.quantity,
					')'
				),
				_react2.default.createElement(
					'button',
					{ className: 'btn btn-default', onClick: this.updateCart.bind(this) },
					'Add to Cart'
				)
			);
		}
...
},{"../actions/CartActions":1,"../actions/ProductActions":5,"../stores/ProductStore":24,"react":"react"}],15:[function(require,module,exports){
'use strict';
...
var SignUp = function (_React$Component) {
	...
	_createClass(SignUp, [{
		...
		value: function handleSubmit(e) {
			...
			console.log(user);
			_SignUpActions2.default.createUser(user);
		}
	}, {
		key: 'render',
...
},{"../actions/SignUpActions":6,"../stores/SignUpStore":25,"react":"react","react-router":"react-router"}],16:[function(require,module,exports){
'use strict';
...
var _AxiomSci = require('./components/AxiomSci');

var _AxiomSci2 = _interopRequireDefault(_AxiomSci);
...
exports.default = _react2.default.createElement(
	_reactRouter.Route,
	{ component: _AxiomSci2.default },
	_react2.default.createElement(_reactRouter.Route, { path: '/', component: _Home2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/signup', component: _SignUp2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/login', component: _Login2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/products/:sku', component: _Product2.default })
);

},{"./components/AxiomSci":8,"./components/Home":11,"./components/Login":12,"./components/Product":14,"./components/SignUp":15,"react":"react","react-router":"react-router"}],20:[function(require,module,exports){
'use strict';
...
var CartStore = function () {
	function CartStore() {
		...
		this.bindActions(_CartActions2.default);
		this.cart = {};
...
exports.default = _alt2.default.createStore(CartStore);

},{"../actions/CartActions":1,"../alt":7}],21:[function(require,module,exports){
'use strict';
...
var HomeStore = function () {
	...
	_createClass(HomeStore, [{
		...
		value: function onGetProductsSuccess(data) {
			...
			this.zerg = _lodash2.default.filter(data, { category: 'Zerg' });
			this.protoss = _lodash2.default.filter(data, { category: 'Protoss' });
			this.materials = _lodash2.default.filter(data, { category: 'Material' });
		}
	}]);
...
},{"../actions/HomeActions":2,"../alt":7,"lodash":45}],22:[function(require,module,exports){
'use strict';
...
},{"../actions/LoginActions":3,"../alt":7,"react":"react"}],23:[function(require,module,exports){
'use strict';
...
var ProductStore = function () {
	function ProductStore() {
		...
		this.bindActions(_ProductActions2.default);
		this.name = '';
		this.category = '';
		this.variant = '';
		this.sku = 0;
...
},{"../actions/ProductActions":5,"../alt":7,"lodash":45}],25:[function(require,module,exports){
'use strict';
...
},{"../actions/SignUpActions":6,"../alt":7,"react":"react"}],26:[function(require,module,exports){
